...
import { addSubcontractor } from '@/utils/subcontractorManager';
...
export default function AddSubcontractorScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      console.log('[AddSubcontractor] Saving subcontractor:', name);
      ...
      console.error('[AddSubcontractor] Error adding subcontractor:', error);
